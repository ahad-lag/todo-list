...
export default function DeleteModal({ showModal , setShowModal , deleteTodoHandler , children}){
                            ...
                            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                ...
                                <div className="sm:flex sm:items-center">
                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <Dialog.Title as="h3" className="text-lg leading-6 font-medium text-gray-900 mx-2">
